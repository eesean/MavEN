...
export const ActivityForm = ({ className }: ActivityFormProps) => {
    return (
        <div className={styles.root}>
            <h2 className={styles['form-title']}>Activity Form Request</h2>
            <form className={styles.form}>
                ...
                <div className={styles['form-row']}>
                    ...
                    <input id="activity-time-start" type="time" className={styles['form-input']} />
                </div>
                <div className={styles['form-row']}>
                    <label htmlFor="activity-time-end" className={styles['form-label']}>
                        Time End:
                    </label>
                    <input id="activity-time-end" type="time" className={styles['form-input']} />
                </div>
                <div className={styles['form-row']}>
